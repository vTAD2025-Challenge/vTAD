    ...
    def load_data(self):
        ...
        with open(self.file_path, 'r') as file:
            for line in file:
                ...
                embedding1 = torch.load(parts[1])  # (1, 256)
                embedding2 = torch.load(parts[2])  # (1, 256)
...
if __name__ == '__main__':
    ...
    test_file = config['infer_facodec']['test_path']
    model_output_path = config['infer_facodec']['model_output']
    checkpoint_path = config['infer_facodec']['checkpoint_path']
