...
import torch
from model.ecapa_tdnn_xivector_uncertainty_bottleneckfeature import ECAPA_TDNN_XiVec_Uncer_BottlenekFeature
from model.ecapa_tdnn_xivector_uncertainty_bottleneckfeature_prior import ECAPA_TDNN_XiVec_Uncer_BottlenekFeature_Prior

in_model_file = "exp/ecapaxiuncer_c1024_pytorchBN_bottleneckfeature_noBNonFrame_kld_prec/70.params"
out_model_file = "exp/ecapaxiuncer_c1024_pytorchBN_bottleneckfeature_noBNonFrame_kld_prec/70.prior.params"
...
model_params = {
    ...
    "pooling": "xi-postmean-softplus2-uncer-bottleneck-feature-stdprec-kld",
    "pooling_params": {
        "num_nodes":1536,
        "num_head":16,
        "share":True,
...
model_in = ECAPA_TDNN_XiVec_Uncer_BottlenekFeature(80, 7205, **model_params)

model_out = ECAPA_TDNN_XiVec_Uncer_BottlenekFeature_Prior(80, 7205, **model_params)
