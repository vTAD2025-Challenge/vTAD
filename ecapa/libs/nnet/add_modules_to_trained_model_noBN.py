...
import torch
from model.ecapa_tdnn_xivector_uncertainty_noBN import ECAPA_TDNN_XiVec_Uncer_noBN
from model.ecapa_tdnn_xivector_uncertainty_prior_noBN import ECAPA_TDNN_XiVec_Uncer_Prior_noBN

in_model_file = "exp/ecapaxiuncer_c1024_noBN/29.params"
out_model_file = "exp/ecapaxiuncer_c1024_noBN/29.prior.params"
...
model_in = ECAPA_TDNN_XiVec_Uncer_noBN(80, 7205, **model_params)

model_out = ECAPA_TDNN_XiVec_Uncer_Prior_noBN(80, 7205, **model_params)
